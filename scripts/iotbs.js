...
screenSwitcher.defineClass('proposed', 'Proposed');
screenSwitcher.defineClass('alt1', 'Alt1');
screenSwitcher.defineClass('alt2', 'Alt2');

var screenSwitcher = new bodySwitcher('readability-switcher', 'Readability');
screenSwitcher.defineClass('proposed', 'Proposed');
